      ...
      require('mason-lspconfig').setup {
        ...
        handlers = {
          ...
          omnisharp = function()
            ...
            local omnisharp_root = omnisharp_pkg:get_install_path()

            -- Detect OS and choose the right binary
            local omnisharp_bin
            if vim.loop.os_uname().sysname == 'Windows_NT' then
              omnisharp_bin = omnisharp_root .. '\\OmniSharp.exe'
            else
              omnisharp_bin = omnisharp_root .. '/omnisharp'
            end
